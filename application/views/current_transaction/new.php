								...
								<form id="form_new">
									<div class="col-12">
										...
										<div class="row" style="margin-bottom:1em;">
											...
											<div class="col-md-2">
												<input type="text" id="date_new" name="date_new" value="<?= date('Y-m-d'); ?>" class="form-control field_new" autocomplete="off" readonly  />
											</div>

											<div class="col-md-1 text-right">Status</div>
											<div class="col-md-2">
												<input type="text" id="status_new" name="status_new" class="form-control field_new" value="UNSAVED" readonly disabled />
											</div>

											<div class="col-md-2 text-right">Trans Type <i class="text-danger">*</i></div>
											<div class="col-md-3">
												<select id="trans_type_id_new" name="trans_type_id_new" class="chosen-select form-control field_new" >
										...
										<div class="row" style="margin-bottom:1em;">
											...
											<div class="col-md-5">
												<div class="input-group">
													<select id="patient_id_new" name="patient_id_new" class="chosen-select form-control field_new" >
														<option value="">-- SELECT --</option>
														<?php
											...
											<div class="col-md-3">
												<select id="payment_method_id_new" name="payment_method_id_new" class="chosen-select form-control field_new" >
													<option value="">-- SELECT --</option>
													<?php
										...
										<div class="row" style="margin-bottom:1em;">
											...
											<div class="col-md-5">
												<div class="input-group">
													<select id="client_id_new" name="client_id_new" class="chosen-select form-control field_new" >
														<option value="">-- SELECT --</option>
														<?php
											...
											<div class="col-md-3">
												<select id="charging_type_id_new" name="charging_type_id_new" class="chosen-select form-control field_new" >
													<option value="">-- SELECT --</option>
													<?php
										...
										<div class="row" style="margin-bottom:1em;">
											...
											<div class="col-md-5">
												<select id="insurance_id_new" name="insurance_id_new" class="chosen-select form-control field_new" >
											...
											<div class="col-md-3">
												<input type="text" id="po_no_new" name="po_no_new" class="form-control field_new" value=""  />
											</div>
										</div>
										...
										<div class="row" style="margin-bottom:1em;">
											...
											<div class="col-md-2">
												<select id="location_id_new" name="location_id_new" class="chosen-select form-control field_new" disabled>
													<option value="">-- SELECT --</option>
													<?php
											...
											<div class="col-md-2">
												<select id="queue_id_new" name="queue_id_new" class="chosen-select form-control field_new" disabled>
													<?php
											...
											<div class="col-md-3">
												<select id="doctor_id_new" name="doctor_id_new" class="chosen-select form-control field_new" >
										...
										<div class="row" style="margin-bottom:1em;">
											...
											<div class="col-md-5">
												<textarea id="remarks_new" name="remarks_new" class="form-control field_new" ></textarea>
											</div>

											<div class="col-md-2 text-right">Diagnosis</div>
											<div class="col-md-3">
												<textarea id="diagnosis_new" name="diagnosis_new" class="form-control field_new" ></textarea>
											</div>
										</div>
			...
			if (dt && patient_id && trans_type_id && trans_type_id && payment_method_id && charging_type_id){
				bootbox.confirm("Are you sure you want to confirm this transaction?", function(result) {
					if (result) {
						...
						$.post("<?= base_url(); ?>current_transaction/save", formData, function(data) {
							if (data.indexOf("<!DOCTYPE html>") > -1) {
								...
								if (result.success == true) {
									window.location = "<?= base_url(); ?>current_transaction/view/" + result.data;
								} else {
									$("#loading").modal("hide");
