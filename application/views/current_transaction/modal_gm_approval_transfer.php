<!-- bootstrap modal -->
<div id='modal_gm_approval_transfer' class="modal fade" tabindex="-1" users="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row" style="margin-bottom: 0.5em;">
                    <div class="col-md-12">
                        <label for="txt_gm_approver_transfer">Approver</label>
                        <select id="txt_gm_approver_transfer" name="txt_gm_approver_transfer"
                            class="form-control select2">
                            <option value="">-- SELECT --</option>
                            <?php
                            foreach ($gm_approvers as $key => $value) {
            ...
            <div class="modal-footer">
                ...
                <div class="pull-right modal_button">
                    <button type="button" id="btn_gm_approver_transfer_send" class="btn btn-xs btn-primary">
