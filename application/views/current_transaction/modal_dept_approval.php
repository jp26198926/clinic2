<!-- bootstrap modal -->
<div id='modal_dept_approval' class="modal fade" tabindex="-1" users="dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row" style="margin-bottom: 0.5em;">
                    <div class="col-md-12">
                        <label for="txt_dept_approver">Approver</label>
                        <select id="txt_dept_approver" name="txt_dept_approver" class="form-control select2">
            ...
            <div class="modal-footer">
                ...
                <div class="pull-right modal_button">
                    <button type="button" id="btn_dept_approver_send" class="btn btn-xs btn-primary">
                        <span class='fa fa-check'></span>
                        Send for Dept Approval
                    </button>
