<!-- bootstrap modal -->
	<div id='modal_changepass' class="modal fade" tabindex="-1" users="dialog">
	  	<div class="modal-dialog modal-sm" users="document">
	    	<div class="modal-content">
	      		<div class="modal-header">
					...
					<input type="hidden" class="hidden_user_id" />
	      		</div>
	      		<div class="modal-body">
					<div class="row" style="margin-bottom: 0.5em;">				        
						<div class="col-sm-12">
				            <label>Current Password *</label>
				            <input type="password" id="txt_changepass_currentpassword" class="field_user form-control" />
				        </div>
					</div>
	        		<div class="row" style="margin-bottom: 0.5em;">				        
						<div class="col-sm-12">
				            <label>New Password *</label>
				            <input type="password" id="txt_changepass_password" class="field_user form-control" />
				        </div>
					</div>
					<div class="row" style="margin-bottom: 0.5em;">	
						<div class="col-sm-12">
				            <label>ReType Password *</label>
				            <input type="password" id="txt_changepass_repassword" class="field_user form-control" />
				        </div>
				    </div>					
