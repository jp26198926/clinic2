...
<body class="no-skin">
    ...
    <div class="main-container ace-save-state" id="main-container">
        ...
        <?php
        $this->load->view('data_category/modal_new');
        $this->load->view('data_category/modal_modify');
        $this->load->view('data_category/modal_info');
        $this->load->view('data_category/modal_asearch');
    ...
    function populate_table(table_ref, result_data) {
        ...
        $.each(result_data, function(index, value) {
            ...
            dataSet.push([option, value.category, status, id, status_id]);
        });
    ...
    $(document).on("click", "#btn_search", function() {
        ...
        $.get("<?= base_url(); ?>data_category/search?search=" + search, function(data) {
            $("#loading").modal("hide");
    ...
    $(document).on("click", "#btn_asearch_start", function() {
        ...
        $.post("<?= base_url(); ?>data_category/advance_search", {
            category: category,
            status_id: status_id
        }, function(data) {
    ...
    $(document).on("click", "#btn_save", function() {
        ...
        if (category) {
            ...
            $.post("<?= base_url(); ?>data_category/add", {
                category: category
            }, function(data) {
    ...
    $(document).on("click", ".btn_modify", function(e) {
        ...
        if (id) {
            ...
            $.post("<?= base_url(); ?>data_category/search_info_row", {
                id: id
            }, function(data) {
    ...
    $(document).on("click", "#btn_update", function() {
        ...
        if (id) {
            if (category) {
                ...
                $.post("<?= base_url(); ?>data_category/update", {
                    id: id,
                    category: category
                }, function(data) {
        ...
        if (id) {
            ...
            bootbox.prompt({
                ...
                callback: function(result) {
                    ...
                    if (result !== null) {
                        if (result) {
                            $.post("<?= base_url(); ?>data_category/delete", {
                                id: id,
                                reason: result
                            }, function(data) {
                                if (data.indexOf("<!DOCTYPE html>") > -1) {
        ...
        if (id) {
            ...
            bootbox.confirm("Are you sure you want to ACTIVATE this data?", function(result) {
                if (result) {
                    ...
                    $.post("<?= base_url(); ?>data_category/activate", {
                        id: id
                    }, function(data) {
