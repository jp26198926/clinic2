            ...
            <div class="modal-body">
				...
				<div class="row" style="margin-bottom: 0.5em;">
                    <div class="col-sm-12">
                        ...
                        <input type="text" id="txt_company_name_info" class="txt_field_info form-control" disabled />
                    </div>
                </div>
                <div class="row" style="margin-bottom: 0.5em;">
                    <div class="col-sm-6">
                        <label>Value Type</label>
                        <select id="txt_value_type_id_info" class="txt_field_info form-control" disabled>
                    ...
                    <div class="col-sm-6">
                        <label>Value</label>
                        <input type="text" id="txt_value_info" class="numeric txt_field_info form-control" disabled />
                    </div>
                </div>
                ...
                <div class="row" style="margin-bottom: 0.5em;">
                    <div class="col-sm-6">
                        ...
                        <select id="txt_commission_type_id_info" class="txt_field_info form-control" disabled>
                            <option value="">-- ALL --</option>
                            <?php
                            foreach ($value_types as $key => $val) {
                                $id = $val->id;
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" id="txt_commission_value_info" class="numeric txt_field_info form-control" disabled />
                    </div>
                </div>
