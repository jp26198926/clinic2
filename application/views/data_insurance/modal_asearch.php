        ...
        <div class="modal-content">
                ...
                <div class="row" style="margin-bottom: 0.5em;">
                    ...
                    <div class="row" style="margin-bottom: 0.5em;">
                        <div class="col-sm-4">
                            ...
                            <select id="txt_value_type_id_asearch" class="txt_field_asearch form-control">
                        ...
                        <div class="col-sm-4">
                            <label>Value</label>
                            <input type="text" id="txt_value_asearch" class="numeric txt_field_asearch form-control" />
                        </div>
                    </div>
                    ...
                    <div class="row" style="margin-bottom: 0.5em;">
                        <div class="col-sm-4">
                            ...
                            <select id="txt_commission_type_id_asearch" class="txt_field_asearch form-control">
                                <option value="">-- ALL --</option>
                                <?php
                                foreach ($value_types as $key => $val) {
                                    $id = $val->id;
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="text" id="txt_commission_value_asearch" class="numeric txt_field_asearch form-control" />
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <div class="pull-right modal_button">
                    <button type="button" id="btn_asearch_start" class="btn btn-sm btn-asearch"><span class="fa fa-check"></span> Search</button>
                ...
                <div class="modal_waiting" style="display:none">
                    <div class="progress">
                        <div class="progress-bar progress-bar-asearch progress-bar-striped active" users="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width:100%">
