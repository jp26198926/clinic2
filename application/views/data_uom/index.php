...
<body class="no-skin">
    ...
    <div class="main-container ace-save-state" id="main-container">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div>
                                        <table id="tbl_list"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td align='center' colspan='4'>Use search button to display record
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
        ...
        <?php
		$this->load->view('data_uom/modal_new');
		$this->load->view('data_uom/modal_modify');
		$this->load->view('data_uom/modal_info');
		$this->load->view('data_uom/modal_asearch');
    ...
    function populate_table(table_ref, result_data) {
        ...
        $.each(result_data, function(index, value) {
            ...
            dataSet.push([option, value.code, value.name, status, id, status_id]);
        });
    ...
    $(document).on("click", "#btn_search", function() {
        ...
        $.get("<?= base_url(); ?>data_uom/search?search=" + search, function(data) {
            $("#loading").modal("hide");
    ...
    $(document).on("click", "#btn_asearch_start", function() {
        ...
        $.post("<?= base_url(); ?>data_uom/advance_search", {
            code: code,
            name: name,
            status_id: status_id
        }, function(data) {
    ...
    $(document).on("click", ".btn_modify", function(e) {
        ...
        if (id) {
            ...
            $.post("<?= base_url(); ?>data_uom/search_info_row", {
                id: id
            }, function(data) {
        ...
        if (id) {
            ...
            bootbox.confirm("Are you sure you want to ACTIVATE this data?", function(result) {
                if (result) {
                    ...
                    $.post("<?= base_url(); ?>data_uom/activate", {
                        id: id
                    }, function(data) {
