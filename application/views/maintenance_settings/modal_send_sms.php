<!-- bootstrap modal -->
<div id='modal_send_sms' class="modal fade" tabindex="-1" users="dialog">
	<div class="modal-dialog modal-sm" users="document">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal">&times;</button>
				<h4 class="blue bigger"><i class="fa fa-plus fa-fw"></i>Send SMS</h4>
			</div>
			<div class="modal-body">
				<div class="row" style="margin-bottom: 0.5em;">
					<div class="col-sm-12">
						<label> Mobile No. <span class="text-danger">*</span></label>
						<input type="text" id="txt_sms_to" class="txt_field_sms form-control" />
					</div>
				</div>
				<div class="row">
					<div class="col-sm-12">
						<label> Message <span class="text-danger">*</span></label>
						<textarea id="txt_sms_message" class="txt_field_sms form-control"></textarea>
					</div>
				</div>
			...
			<div class="modal-footer">
				<div class="pull-right modal_button">
					<button type="button" id="btn_send_sms" class="btn btn-xs btn-info"><span class='fa fa-send'></span> Send </button>
