        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row" style="margin-bottom: 0.5em;">
                    ...
                    <div class="col-sm-12">
                        <label>Address</label>
                        <textarea id="txt_address_asearch" class="txt_field_asearch form-control"></textarea>
                    </div>
                    <div class="col-sm-6">
                        <label>Phone</label>
                        <input type="text" id="txt_phone_asearch" class="txt_field_asearch form-control" />
                    </div>
                    <div class="col-sm-6">
                        <label>Status</label>
