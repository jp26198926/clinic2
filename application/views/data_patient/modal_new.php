            ...
            <div class="modal-body">
                <div class="row" style="margin-bottom: 0.5em;">
                    <div class="col-md-4">
                        ...
                        <input type="text" id="txt_lastname" class="txt_field form-control" />
                    </div>
                    <div class="col-md-4">
                        <label>Firstname <span class="text-danger">*</span></label>
                        <input type="text" id="txt_firstname" class="txt_field form-control" />
                    </div>
                    <div class="col-md-4">
                        <label>Middlename</label>
                        <input type="text" id="txt_middlename" class="txt_field form-control" />
                    </div>
                </div>
                <div class="row" style="margin-bottom: 0.5em;">
                    <div class="col-md-4">
                        <label>Gender</label>
                        <select id="txt_gender_id" class="txt_field form-control">
                    ...
                    <div class="col-md-4">
                        ...
                        <select id="txt_civil_id" class="txt_field form-control">
                            <option value="">-- ALL --</option>
                            <?php
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="txt_contact_no" class="txt_field form-control" />
                    </div>
                </div>
                <div class="row" style="margin-bottom: 0.5em;">
                    <div class="col-md-12">
