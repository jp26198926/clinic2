    ...
    <div class="modal-dialog" users="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button_update" class="close" data-dismiss="modal">&times;</button>
            ...
            <div class="modal-body">
                <div class="row" style="margin-bottom: 0.5em;">
                    <div class="col-md-4">
                        ...
                        <input type="text" id="txt_lastname_update" class="txt_field_update form-control" />
                    </div>
                    <div class="col-md-4">
                        <label>Firstname <span class="text-danger">*</span></label>
                        <input type="text" id="txt_firstname_update" class="txt_field_update form-control" />
                    </div>
                    <div class="col-md-4">
                        <label>Middlename</label>
                        <input type="text" id="txt_middlename_update" class="txt_field_update form-control" />
                    </div>
                </div>
                <div class="row" style="margin-bottom: 0.5em;">
                    <div class="col-md-4">
                        <label>Gender</label>
                        <select id="txt_gender_id_update" class="txt_field_update form-control">
                    ...
                    <div class="col-md-4">
                        ...
                        <select id="txt_civil_id_update" class="txt_field_update form-control">
                            <option value="">-- ALL --</option>
                            <?php
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="txt_contact_no_update" class="txt_field_update form-control" />
                    </div>
                </div>
                <div class="row" style="margin-bottom: 0.5em;">
                    <div class="col-md-12">
                        <label>Address</label>
                        <textarea id="txt_address_update" class="txt_field_update form-control"></textarea>
                    </div>
                </div>
            </div>
