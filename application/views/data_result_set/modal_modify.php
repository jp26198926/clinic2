            ...
            <div class="modal-body">
                <div class="row" style="margin-bottom: 0.5em;">
                    <div class="col-sm-12">
                        ...
                        <select id="txt_product_id_update" class="txt_field_update form-control chosen-select">
                ...
                <div class="row" style="margin-bottom: 0.5em;">
                    <div class="col-sm-6">
                        ...
                        <select id="txt_category_id_update" class="txt_field_update form-control" disabled>
                            <option value="">-- SELECT --</option>
                            <?php
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="text" id="txt_result_label_update" class="txt_field_update form-control" />
                    </div>
                </div>
                <div class="row" style="margin-bottom: 0.5em;">
                    <div class="col-sm-6">
                        <label>Reference Value</label>
                        <input type="text" id="txt_reference_update" class="txt_field_update form-control" />
                    </div>
                    <div class="col-sm-6">
                        <label>Unit</label>
                        <input type="text" id="txt_unit_update" class="txt_field_update form-control" />
                    </div>
                </div>
            </div>
