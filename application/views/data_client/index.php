...
<body class="no-skin">
    ...
    <div class="main-container ace-save-state" id="main-container">
                                ...
                                <div class="col-xs-12">
                                    ...
                                    <div>
                                        <table id="tbl_list"
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td align='center' colspan='5'>Use search button to display record
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
        ...
        <?php
		$this->load->view('data_client/modal_new');
		$this->load->view('data_client/modal_modify');
		$this->load->view('data_client/modal_info');
		$this->load->view('data_client/modal_asearch');
    ...
    function populate_table(table_ref, result_data) {
        ...
        $.each(result_data, function(index, value) {
            ...
            dataSet.push([option, value.name, value.address, value.phone, status, id, status_id]);
        });
    ...
    $(document).on("click", "#btn_search", function() {
        ...
        $.get("<?= base_url(); ?>data_client/search?search=" + search, function(data) {
            $("#loading").modal("hide");
    ...
    $(document).on("click", "#btn_asearch_start", function() {
        ...
        $.post("<?= base_url(); ?>data_client/advance_search", {
            name: name,
            address: address,
            phone: phone,
            status_id: status_id
    ...
    $(document).on("click", ".btn_modify", function(e) {
        ...
        if (id) {
            ...
            $.post("<?= base_url(); ?>data_client/search_info_row", {
                id: id
            }, function(data) {
                ...
                if (data.indexOf("<!DOCTYPE html>") > -1) {
                    ...
                    $("#txt_phone_update").val(data.phone);
    ...
    $(document).on("click", "#btn_update", function() {
        ...
        if (id) {
            if (name) {
                ...
                $.post("<?= base_url(); ?>data_client/update", {
                    id: id,
                    name: name,
                    address: address,
                    phone: phone
                    ...
                    if (data.indexOf("<!DOCTYPE html>") > -1) {
                        ...
                        current_data[1] = name;
                        current_data[2] = address;
                        current_data[3] = phone;
        ...
        if (id) {
            ...
            bootbox.prompt({
                ...
                callback: function(result) {
                    ...
                    if (result !== null) {
                        if (result) {
                            $.post("<?= base_url(); ?>data_client/delete", {
                                id: id,
                                reason: result
                            }, function(data) {
                                if (data.indexOf("<!DOCTYPE html>") > -1) {
        ...
        if (id) {
            ...
            bootbox.confirm("Are you sure you want to ACTIVATE this data?", function(result) {
                if (result) {
                    ...
                    $.post("<?= base_url(); ?>data_client/activate", {
                        id: id
                    }, function(data) {
