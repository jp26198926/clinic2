<!-- bootstrap modal -->
	<div id='modal_parent_modify' class="modal fade" tabindex="-1" module="dialog">
	  	<div class="modal-dialog" module="document">
	    	<div class="modal-content">
	      		<div class="modal-header">
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="blue bigger"><i class="fa fa-pencil fa-fw"></i>Modify Parent</h4>
					<input type='hidden' class='hidden_parent_id' />
	      		</div>
	      		<div class="modal-body">
	        		...
	        		<div class="row" style="margin-bottom: 0.5em;">
				        <div class="col-sm-12">
				            ...
				            <input type="text" id="txt_parent_name_update" class="field_parent form-control" />
				        </div>
					</div>
					<div class="row" style="margin-bottom: 0.5em;">
						<div class="col-sm-12">
				            <label>Parent Description</label>
				            <input type="text" id="txt_parent_description_update" " class="field_parent form-control" />
				        </div>
					</div>
					<div class="row" style="margin-bottom: 0.5em;">	
						<div class="col-sm-12">
				            <label>Parent Icon (Sample: fa-user)</label>
				            <input type="text" id="txt_parent_icon_update" class="field_parent form-control" />
					...
					<div class="row" style="margin-bottom: 0.5em;">
						<div class="col-sm-12">
				            ...
				            <input type="text" id="txt_parent_order_update" " class="field_parent form-control" />
				        </div>
					</div>
	      		...
	      		<div class="modal-footer">
	      			...
	      			<div class="pull-right modal_button">
						<button type="button" id="btn_parent_update" class="btn btn-info" ><span class='fa fa-check'></span> Save </button>
