		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row" style="margin-bottom: 0.5em;">
					...
					<div class="col-sm-12">
						<label>Status</label>
						<select id="txt_status_info" class="txt_field_asearch form-control" disabled>
			...
			<div class="modal-footer">
				...
				<div class="pull-right modal_button">
					<button type="button" class="btn btn-xs btn-danger" data-dismiss="modal"><span class='fa fa-times'> Close</button>
				</div>
