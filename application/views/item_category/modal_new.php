		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row" style="margin-bottom: 0.5em;">
					<div class="col-sm-12">
						...
						<input type="text" id="txt_category" class="txt_field form-control" />
					</div>
				</div>
			</div>
			<div class="modal-footer">
				...
				<div class="pull-right modal_button">
					<button type="button" id="btn_save" class="btn btn-xs btn-info"><span class='fa fa-check'></span> Save </button>
