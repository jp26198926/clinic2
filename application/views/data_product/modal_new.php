            ...
            <div class="modal-body">
                <div class="row" style="margin-bottom: 0.5em;">
                    <div class="col-sm-4">
                        ...
                        <input type="text" id="txt_code" class="txt_field form-control" />
                    </div>
                    <div class="col-sm-8">
                ...
                <div class="row" style="margin-bottom: 0.5em;">
                    <div class="col-sm-4">
                        <label>UOM</label>
                        <select id="txt_uom_id" class="txt_field form-control">
                    ...
                    <div class="col-sm-8">
                        ...
                        <select id="txt_category_id" class="txt_field form-control">
                            <option value="">-- SELECT --</option>
                            <?php
                ...
                <div class="row" style="margin-bottom: 0.5em;">
                    <div class="col-md-3">
                        <label>Amount</label>
                        <input type="text" id="txt_amount" placeholder="0.00" class="numeric txt_field form-control text-center" />
                    </div>
                    <div class="col-md-3">
                        <label>Amount PO</label>
                        <input type="text" id="txt_amount_po" placeholder="0.00" class="numeric txt_field form-control text-center" />
                    </div>
                    <div class="col-md-3">
                        <label>After Office AMT</label>
                        <input type="text" id="txt_after_amount" placeholder="0.00" class="numeric txt_field form-control text-center" />
                    </div>
                    <div class="col-md-3">
                        <label>After office AMT PO</label>
                        <input type="text" id="txt_after_amount_po" placeholder="0.00" class="numeric txt_field form-control text-center" />
                    </div>
                </div>
            </div>
