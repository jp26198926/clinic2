            ...
            <div class="modal-body">
                <div class="row" style="margin-bottom: 0.5em;">
                    <div class="col-sm-4">
                        ...
                        <input type="text" id="txt_code_asearch" class="txt_field_asearch form-control" />
                    </div>
                    <div class="col-sm-8">
                ...
                <div class="row" style="margin-bottom: 0.5em;">
                    <div class="col-sm-4">
                        <label>UOM</label>
                        <select id="txt_uom_id_asearch" class="txt_field_asearch form-control">
                    ...
                    <div class="col-sm-8">
                        ...
                        <select id="txt_category_id_asearch" class="txt_field_asearch form-control">
                            <option value="">-- ALL --</option>
                            <?php
                ...
                <div class="row" style="margin-bottom: 0.5em;">
                    <div class="col-sm-4">
                        <label>Amount</label>
                        <input type="text" id="txt_amount_asearch" placeholder="0.00"
                            class="numeric txt_asearch form-control" />
                    </div>
                    <div class="col-sm-4">
                        <label>Amount PO</label>
                        <input type="text" id="txt_amount_po_asearch" placeholder="0.00"
                            class="numeric txt_asearch form-control" />
                    </div>
                    <div class="col-sm-4">
                        <label>Status</label>
