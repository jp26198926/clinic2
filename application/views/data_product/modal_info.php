            ...
            <div class="modal-body">
                <div class="row" style="margin-bottom: 0.5em;">
                    <div class="col-sm-4">
                        ...
                        <input type="text" id="txt_code_info" class="txt_field_info form-control" disabled />
                    </div>
                    <div class="col-sm-8">
                ...
                <div class="row" style="margin-bottom: 0.5em;">
                    <div class="col-sm-4">
                        <label>UOM</label>
                        <select id="txt_uom_id_info" class="txt_field_info form-control" disabled>
                ...
                <div class="row" style="margin-bottom: 0.5em;">
                    <div class="col-md-3">
                        <label>Amount</label>
                        <input type="text" id="txt_amount_info" placeholder="0.00" class="numeric txt_info form-control text-center" disabled />
                    </div>
                    <div class="col-md-3">
                        <label>Amount PO</label>
                        <input type="text" id="txt_amount_po_info" placeholder="0.00" class="numeric txt_info form-control text-center" disabled />
                    </div>
                    <div class="col-md-3">
                        <label>After Office AMT</label>
                        <input type="text" id="txt_after_amount_info" placeholder="0.00" class="numeric txt_info form-control text-center" disabled />
                    </div>
                    <div class="col-md-3">
                        <label>After Office AMT PO</label>
                        <input type="text" id="txt_after_amount_po_info" placeholder="0.00" class="numeric txt_info form-control text-center" disabled />
                    </div>
                </div>
                <div class="row" style="margin-bottom: 0.5em;">
                    <div class="col-sm-4">
