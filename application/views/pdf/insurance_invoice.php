...
function details($record)
{
	...
	$transaction_no = "INS" . $record->transaction_no;

	$details = " <table>
						<tr>
							<td align=\"right\" width=\"15%\"><b>BILL TO : </b></td>
							<td align=\"left\" width=\"45%\">{$record->insurance_company_name}</td>
							<td align=\"right\" width=\"15%\"><b>INVOICE # : </b></td>
							<td align=\"left\" width=\"25%\">{$transaction_no}</td>
						</tr>
						<tr>
				...
				<table>
						...
						<tr>
                            ...
                            <td align=\"left\" width=\"25%\">{$record->trans_type}</td>
                        </tr>
						<tr>
                            <td align=\"right\" width=\"15%\"><b>COMPANY : </b></td>
                            <td align=\"left\" width=\"85%\">{$record->company}</td>
                        </tr>
						<tr>
...
function summary_list($items, $total_paid=0)
{
	...
	if (count($items) > 0) {
		...
		$list .= "	<td colspan=\"2\" align=\"right\">" . number_format($subtotal_insurance, 2, '.', ',') . "</td>";
...
$pdf->Output('INS' . $record->transaction_no . '.pdf', 'I');
