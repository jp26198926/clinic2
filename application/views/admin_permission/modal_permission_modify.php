<!-- bootstrap modal -->
	<div id='modal_permission_modify' class="modal fade" tabindex="-1" permission="dialog">
	  	<div class="modal-dialog" permission="document">
	    	<div class="modal-content">
	      		<div class="modal-header"> 
					<button type="button" class="close" data-dismiss="modal">&times;</button>
					<h4 class="blue bigger"><i class="fa fa-pencil fa-fw"></i>Modify Permission</h4>
					<input type='hidden' class='hidden_permission_id' />
	      		</div>
	      		<div class="modal-body">
	        			...
	        			<div class="row" style="margin-bottom: 0.5em;">
				            <div class="col-sm-12">
				              	...
				              	<input type="text" name="txt_permission_name_update" id="txt_permission_name_update" class="field_permission form-control" />
				            </div>				            
				        </div>
	      		...
	      		<div class="modal-footer">
	      			...
	      			<div class="pull-right modal_button">
						<button type="button" id="btn_permission_update" class="btn btn-info" ><span class='fa fa-check'></span> Save </button>
