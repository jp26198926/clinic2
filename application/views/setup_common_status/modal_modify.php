	...
	<div class="modal-dialog modal-sm" users="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="blue bigger"><i class="fa fa-plus fa-fw"></i>Modify</h4>
			...
			<div class="modal-body">
				<div class="row" style="margin-bottom: 0.5em;">
					<div class="col-sm-12">
						...
						<input type="text" id="txt_status_update" class="txt_field form-control" />
					</div>
				</div>
			</div>
			<div class="modal-footer">
				...
				<div class="pull-right modal_button">
					<button type="button" id="btn_update" class="btn btn-sm btn-info"><span class='fa fa-check'></span> Update</button>
