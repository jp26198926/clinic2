 ...
 * 13 - HEO
 */
class Location_heo extends Current_transaction
{
	...
	protected $role_id;
	protected $module = "location_heo";
	protected $module_description = "HEO";
	protected $page_name = "HEO";
