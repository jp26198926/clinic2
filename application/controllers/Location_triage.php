 ...
 * 12 - ER
 */
class Location_triage extends Current_transaction
{
	...
	protected $role_id;
	protected $module = "location_triage";
	protected $module_description = "Triage";
	protected $page_name = "Triage";
