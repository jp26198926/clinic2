 ...
 * 12 - ER
 */
class Location_laboratory extends Current_transaction
{
	...
	protected $role_id;
	protected $module = "location_laboratory";
	protected $module_description = "Laboratory";
	protected $page_name = "Laboratory";
