 ...
 * 12 - ER
 */
class Location_reception extends Current_transaction
{
	...
	protected $role_id;
	protected $module = "location_reception";
	protected $module_description = "Reception";
	protected $page_name = "Reception";
